<template>
    <div @click="openInfoWindow(culture)">
        <div :class="culture.type.toLowerCase()">
            <div class='pin' >
...
export default {
    ...
    props: ['culture'],
    methods: {
        openInfoWindow: function (culture) {
            this.$emit('openInfoWindowCulture', culture);
        }
    }
}
</script>
